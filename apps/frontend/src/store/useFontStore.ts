...
export const fontThemes: FontTheme[] = [
  ...
  { fontFamily: 'ui-sans-serif, system-ui, sans-serif', displayName: 'System Default', category: 'sans-serif' },
  ...
  { fontFamily: '"IBM Plex Sans", sans-serif', displayName: 'IBM Plex Sans', category: 'sans-serif' },
  { fontFamily: '"Source Sans Pro", sans-serif', displayName: 'Source Sans Pro', category: 'sans-serif' },
  ...
  // Monospace fonts
  { fontFamily: '"JetBrains Mono", monospace', displayName: 'JetBrains Mono', category: 'monospace' },
  { fontFamily: '"Cascadia Code", "JetBrains Mono", monospace', displayName: 'Cascadia Code', category: 'monospace' },
