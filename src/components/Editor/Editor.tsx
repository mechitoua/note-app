    ...
    <div className="h-full flex flex-col bg-white dark:bg-gray-900">
      <div className="sticky top-0 z-10 bg-white dark:bg-gray-900 border-b border-gray-200 dark:border-gray-700">
        <div className="pl-0 pr-2 py-3 flex items-center justify-between gap-2">
          ...
          <div
            className={`flex items-center gap-1 transition-opacity duration-200 ${isActionsVisible ? 'opacity-100' : 'opacity-0 invisible'}`}
          >
      ...
      <div className="flex-1 flex flex-col">
        <div className="flex flex-col space-y-2">
          <Button
            variant="ghost"
            className={cn('justify-start', !isActionsVisible && !selectedCategory && 'bg-accent')}
            onClick={() => {
          ...
          <Button
            variant="ghost"
            className={cn('justify-start', isActionsVisible && 'bg-accent')}
            onClick={() => {
